	...
	<div class="container">
		...
		<div id="body">
			...
			<div class="jumbotron">
				...
				<h2 class="page-header">${news.title }</h2>
				<p>
					<b>Date: </b>
					<fmt:formatDate value="${news.time }" pattern="yyyy-MM-dd HH:mm:ss" />
				</p>
				<h4
					style="font-family:'Droid Sans', Verdana, 'Microsoft YaHei', Tahoma, sans-serif;color:#333333;font-size:18px;vertical-align:baseline;font-weight:500;">
					<strong><br> </strong>
				</h4>
				${news.content }
